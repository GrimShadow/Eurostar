<div class="space-y-6">
    ...
    <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-gray-900">Add New Check-in Status</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" wire:model="newStatus" 
                           ...
                           placeholder="e.g., Not Started, Pre-check-in">
                    @error('newStatus') 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">Check-in Statuses</h3>
                <div class="flex items-center space-x-2">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <h3 class="text-lg font-medium text-gray-900 mb-2">No check-in statuses</h3>
                                    <p class="text-gray-500">Get started by creating your first check-in status.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
