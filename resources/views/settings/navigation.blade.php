        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('settings.rules')" :active="request()->routeIs('settings.rules')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('settings.aviavox')">
                    {{ __('AviaVox') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('settings.gtfs')">
                    {{ __('GTFS') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('settings.rules')">
                    {{ __('Rules and Triggers') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('settings.users')">
                    {{ __('User Management') }}
                </x-responsive-nav-link>
